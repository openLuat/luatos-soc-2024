...
typedef enum UlPduImsDataType_Tag
{
    ...
    UL_PDU_IMS_VOICE    = 1,    /*the ul pdu with ims voice signaling or RTP data*/
    UL_PDU_IMS_SMS      = 2,    /*the ul pdu with ims SMS signaling data*/
    UL_PDU_IMS_OTHER    = 3,    /*the ul pdu with other IMS UL PDU, such as register signaling, RTCP, and etc*/
    UL_PDU_IMS_DATA_TYPE_MAX = 3    /* as used 2 bits, not max value is 3 */
}UlPduImsDataType;
...
typedef struct UlPduBlock_Tag
{
    ...
    */
    ...
    UINT32      imsDataType :2;     /*ims data type within the ul pdu*/ /*UlPduImsDataType*/
