...
#define CP_PKGIMG_LNA (0x0081B000)
...
#define AP_PKGIMG_LNA (0x008BB000)
#define CP_PKGIMG_LIMIT_SIZE (0xA0000)
#else
#define AP_PKGIMG_LNA (0x0087f000)
...
#define AP_PKGIMG_LIMIT_SIZE (0x28a000)
#endif
#else
#ifndef AP_PKGIMG_LIMIT_SIZE
#define AP_PKGIMG_LIMIT_SIZE (0x2c6000)
#endif
