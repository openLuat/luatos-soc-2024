...
AP_PLAT_COMMON_DATA ccinst_cdc_setting_st t_vcom_custp2_setting_arr[VCOM_CCINST_SUBTP2_3EP_CNT] ={
//[0]
    {
...
AP_PLAT_COMMON_DATA usb_func_ccinst_st t_vcom_func_custp2_arr[VCOM_CCINST_SUBTP2_3EP_CNT] ={
//[0]
    {
