...
AP_PLAT_COMMON_BSS static uint8_t                     can_driver_powered     = 0U;
AP_PLAT_COMMON_BSS static uint8_t                     can_driver_initialized = 0U;
AP_PLAT_COMMON_BSS static ARM_CAN_SignalUnitEvent_t   CAN_SignalUnitEvent    = NULL;
AP_PLAT_COMMON_BSS static ARM_CAN_SignalObjectEvent_t CAN_SignalObjectEvent  = NULL;
